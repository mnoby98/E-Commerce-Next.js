    ...
    <Formik
      ...
      <Form className="  rounded-lg border-2 border-gray-300 bg-white pb-4">
        <div className=" flex items-center  justify-center ">
          <h1 className="text-2xl   text-[#74bec1]  px-4 my-2 rounded py-1">
        ...
        <div className="flex  items-center   justify-center mx-8 ">
          <button
            className="   px-10 rounded-lg  bg-[#74bec1] hover:bg-[#385a5c] text-lg focus:outline-none  focus:ring  focus:ring-offset-1 focus:ring-[#74bec1]   text-center   text-white "
            type="submit">
